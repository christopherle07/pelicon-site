...
<a {{ $attributes->merge(['class' => $classes.' font-unicase', 'style' => ($active ?? false) ? 'border-color: var(--accent); color: var(--brand-green); background: var(--accent-soft);' : 'color: var(--text-muted);']) }}>
    {{ $slot }}
</a>
